    ...
    <nav 
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        isOpen 
          ? 'bg-[#ff2a2a] py-4'
          : isScrolled 
            ? 'bg-black/60 py-4 backdrop-blur-md border-b border-white/10' 
            : 'bg-transparent py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-xs font-bold hover:bg-white/20 transition-all duration-300 backdrop-blur-md"
          >
            Resume
          </button>
          <a 
            href="#contact"
            className="px-6 py-2 rounded-full bg-[#ff2a2a] text-white text-xs font-bold hover:bg-red-600 shadow-[0_0_15px_rgba(255,42,42,0.4)] transition-all duration-300"
          >
            Hire Me
          </a>
        </div>
        ...
        <div className="flex flex-col px-6 space-y-4">
          ...
          <div className="pt-2 pb-2 flex flex-col gap-3">
             <button
               ...
               className="px-6 py-2.5 rounded-full bg-white/20 border border-white/30 text-white font-bold hover:bg-white hover:text-black transition-colors w-full text-center"
             >
               View Resume
             </button>
             <a 
